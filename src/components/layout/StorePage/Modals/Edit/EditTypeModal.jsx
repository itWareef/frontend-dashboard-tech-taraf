...
// schema imports
import { AddNewTypeSchema } from "@/lib/YupSchemas/StorePage/AddNewTypeSchema";
...
const ModelContent = ({ setTableData, selectedRow, setIsOpen }) => {
  ...
  const initialValues = {
    picture: selectedRow?.icon,
    name: selectedRow?.term_name,
...
const EditTypeModel = ({ setTableData, selectedRow, isOpen, setIsOpen }) => {
  return (
    <>
      {isOpen && (
        <ModelContent
