...
// schema imports
import { AddNewFeatureSchema } from "@/lib/YupSchemas/StorePage/AddNewFeatureSchema";
...
const ModelContent = ({ setTableData, selectedRow, setIsOpen }) => {
  const initialValues = {
    ...
    name: selectedRow.advantage_term,
...
const EditFeatureModel = ({ setTableData, selectedRow, isOpen, setIsOpen }) => {
  return (
    <>
      {isOpen && (
        <ModelContent
