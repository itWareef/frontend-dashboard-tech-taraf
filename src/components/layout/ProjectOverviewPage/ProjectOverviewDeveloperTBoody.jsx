...
const ProjectOverviewDeveloperTBody = ({ developersOverview }) => {
  return (
    <tbody>
      {developersOverview.map((developer, index) => (
...
export default ProjectOverviewDeveloperTBody;
