const ContractBody = ({ contracts, handleEdit, handleDelete }) => {
  return (
    <tbody>
      {contracts.map((contract, index) => (
        <tr key={index} className="group text-primary">
          <td className="px-2 py-3 text-center bg-[#C8CCCC] hover:bg-[#B8BCBC] text-sm font-medium whitespace-nowrap transition-colors duration-200 rounded-r-[6px]">
            {contract.clientName}
          </td>
          <td className="px-2 py-3 text-center bg-[#C8CCCC] hover:bg-[#B8BCBC] text-sm font-medium whitespace-nowrap transition-colors duration-200">
            {contract.project}
          </td>
          <td className="px-2 py-3 text-center bg-[#C8CCCC] hover:bg-[#B8BCBC] text-sm font-medium whitespace-nowrap transition-colors duration-200">
            {contract.unitNumber}
          ...
          <td className="px-2 py-3 text-center bg-[#C8CCCC] hover:bg-[#B8BCBC] text-sm font-medium whitespace-nowrap transition-colors duration-200 rounded-l-[6px]">
