      ...
      <tr className="h-[60px] gap-0">
        ...
        <td className="bg-[#C8CCCC] border-l-[1px] border-secondary h-[60px]">
          <input
            ...
            className="placeholder:text-center placeholder:text-primary h-full w-full text-center rounded-l-[6px] border-0 focus:border-0 focus:ring-0 focus:outline-0 text-primary"
          />
        </td>
