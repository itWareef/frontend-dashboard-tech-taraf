...
const ServiceRequestsTBody = ({ gardeningServiceRequests }) => {
  return (
    <tbody>
      {gardeningServiceRequests.map((service, index) => (
        <tr key={index} className="group">
          ...
          <td className="px-2  border-l border-muted  grid place-content-center py-3 text-center text-primary bg-[#C8CCCC] hover:bg-[#B8BCBC] text-sm font-medium whitespace-nowrap transition-colors duration-200 ">
            {svgIcons.doc}
          </td>
...
export default ServiceRequestsTBody;
