...
const ModelContent = ({ setIsOpen, setTableData, tableData }) => {
  ...
  return (
    <div className="absolute inset-0 backdrop-blur-lg z-50 w-full h-full flex items-center justify-center overflow-y-auto ">
      <div className="flex items-center justify-center w-full h-full">
        <div className="flex flex-col items-center w-[65%] max-w-[1100px] h-[70%] bg-white shadow-2xl text-2xl rounded-2xl overflow-hidden">
          <h1 className="bg-[#038d7d] text-white w-full py-5 text-center">
            اضف عرض فني
          </h1>

          <div className="flex flex-col items-center gap-20 p-10 w-full overflow-y-auto">
            {/* ===== Inputs ===== */}
                  ...
                  <div className="flex flex-wrap items-center justify-start md:justify-start gap-6 md:gap-10 w-full">
                    {["customer", "organizations"].map((entityName) => (
                      <Button
                        ...
                        onClick={() => setData({ ...data, entity: entityName })}
                      >
